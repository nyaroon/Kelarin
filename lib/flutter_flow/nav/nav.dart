...
class AppStateNotifier extends ChangeNotifier {
  PMTestAppsFirebaseUser? initialUser;
  PMTestAppsFirebaseUser? user;
  ...
  void update(PMTestAppsFirebaseUser newUser) {
    initialUser ??= newUser;
    user = newUser;
...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, _) =>
          appStateNotifier.loggedIn ? MainTrackerWidget() : LoginWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
            ...
            FFRoute(
              ...
              builder: (context, params) => EditProfileWidget(
                editProfile: params.getParam(
                    'editProfile', ParamType.DocumentReference, 'users'),
              ),
            )
